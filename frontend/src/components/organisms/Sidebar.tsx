...
const Dashboard = ({ children }: TSidebarProps) => {
	...
	return (
		<div className='bg-gray-100 min-h-screen'>
			{/* Navbar */}
			<nav className='bg-gray-800 shadow-lg p-4 flex justify-between items-center sticky top-0 border-b-2 border-white'>
				...
				<div className='text-xl font-bold text-white'>DebtsCRM</div>
			</nav>
