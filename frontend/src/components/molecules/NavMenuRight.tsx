...
const NavMenuRight = () => {
	...
	return user ?
		...
		:	<Anchor href='/signin'>
				<Button className='hover:border-b hover:border-blue-700 text-white font-semibold px-4 rounded transition duration-300 ease-in-out shadow hover:shadow-lg'>
					Login
				</Button>
			</Anchor>;
};
